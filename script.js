...
veryOldInventors = inventors.filter((veryOldInventors) => {
...
inventorNames = inventors.map((inventorNames) => {
  return `first: ${inventorNames.first}, last: ${inventorNames.last}`;
});
...
inventorNamedAda = inventors.find((findAda) => {
...
// Hint: Use the String.prototype.split method to separate the first and last names. You can split the string using ', ' as
// the separator.
